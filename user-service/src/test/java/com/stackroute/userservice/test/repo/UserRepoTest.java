...
public class UserRepoTest {
	...
	UserRepo Repository;
	  ...
	  @Test public void givenNewUserWhenSavedThenReturnUser(){ UserRegistration
	  user = new
	  UserRegistration("hello@gmail.com","Welcome","English",24,"male",90607,"rt12"
	  ,"rt12"); UserRegistration adddeduser = Repository.save(user);
	  assertEquals(user.getEmail(), adddeduser.getEmail(),
	  "New User should be saved and the same should be returned"); }
	  
	  @Test public void givenInValidUserIdThenReturnEmptyOptional(){
	  assertTrue(Repository.findById("hello@gmail.com").isEmpty()); }
	  
	  
	  @Test public void givenValidUserIdThenReturnUserOptional(){ UserRegistration
	  user = new
	  UserRegistration("hello@gmail.com","Welcome","English",24,"male",90607,"rt12"
	  ,"rt12"); Repository.save(user);
