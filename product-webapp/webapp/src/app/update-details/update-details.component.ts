...
firstname: String;
  ...
  constructor(private domSanitizer: DomSanitizer,private updateDetailsService: UpdateDetailsService, private router: Router, private route: ActivatedRoute) {
  ...
  ngOnInit(): void {
    ...
    this.updateDetailsService.getUserDetailByEmail("nkkkk@gmail.com").subscribe(data => {
      this.employees= data
  ...
  onClickSubmitForm() {
    ...
    // To reset the form
      ...
      Swal.fire({ icon: 'success', title: 'Successfully Updated!!', text: 'Your Profile Updated Succesfully !', })
