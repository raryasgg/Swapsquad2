...
export class MyProfileComponent implements OnInit {
 ...
 public employees: UserRegistration;
  ...
  constructor(private domSanitizer: DomSanitizer,private userratingservice:UpdateDetailsService,private router: Router,private route: ActivatedRoute) { }

  ngOnInit(): void {
    this.email = this.route.snapshot.params['email'];
    this.employees = new UserRegistration();
    this.userratingservice.getUserDetailByEmail("nkkkk@gmail.com").subscribe(data=>{
      this.employees=data
